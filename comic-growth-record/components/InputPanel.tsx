...
export const InputPanel: React.FC<InputPanelProps> = ({ 
  ...
  openCharLib, characters, style, setStyle, ratio, setRatio
}) => {
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-wrap gap-4">
            {characters.slice(0, 4).map(char => (
              <div key={char.id} className="flex flex-col items-center gap-1 group cursor-pointer" title={char.name}>
                <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-transparent group-hover:border-primary-200 transition-colors">
